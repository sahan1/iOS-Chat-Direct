...
class ConnectionManager: NSObject {
    ...
    override init() {
        self.serviceAdvertiser = MCNearbyServiceAdvertiser(peer: deviceid, discoveryInfo: nil, serviceType: connecttype)
        self.serviceBrowser = MCNearbyServiceBrowser(peer: deviceid, serviceType: connecttype)
    ...
    lazy var session : MCSession = {
        let session = MCSession(peer: self.deviceid, securityIdentity: nil, encryptionPreference: .required)
...
extension ConnectionManager : MCSessionDelegate {
    ...
    func session(_ session: MCSession, didReceive data: Data, fromPeer peerID: MCPeerID) {
        ...
        self.delegate?.messagerecieved(manager: self, messagestring: str)
    }
